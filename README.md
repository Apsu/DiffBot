...
- Almost entirely common parts and materials. The example gears are printed, though there are cheap sources of gears near the right size and shape, and the example gearbox allows for clamping gears to nuts and screws without requiring purely custom gear shapes, but printing them is certainly easier.
